...
students: [
    samuel-downs, jasmine-roach, kevin-rubio
]
instructors: [
    cindy-robertson, anca-doloc-mihu
]
techs: [
    "makey-makey", "audacity","scratch"
]
videos: [
    {src: "4wJp5NOrG9k?si=w6tbLCWE08v_sxyN", caption: " Audacity Instructions "},
    {src: "8j_1j9whbqU?si=tiSmM1aCgAkrHjqg", caption: " Makey Makey Set up "},
    {src: "v48wo3d30LI?si=lgDXIbEOsl7P7Eoc", caption: " Monster Makey Project Demo "},
    {src: "Uc4cUQW9awg?si=p1LZg84rcHIwwx-h", caption: "Monster Makey Workshop"},
...
## Team members
<Photo src={monsterMakeyGroupPhoto.src} alt="Monster Makey Photo" caption="From left to right: Samuel Downs, Jasmine Roach and Kevin Rubio"/>
<br />
...
<iframe style="width: 100%; max-width: 800px; height: 450px;" src="https://www.youtube.com/embed/4wJp5NOrG9k?si=xV2YGGAmXSwNZa5P" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
- [Setting up MakeyMakey](https://youtu.be/8j_1j9whbqU?si=7mrQMEuXpHCfUv-E)
<iframe style="width: 100%; max-width: 800px; height: 450px;" src="https://www.youtube.com/embed/8j_1j9whbqU?si=7mrQMEuXpHCfUv-E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
4. Head to [Scratch](https://scratch.mit.edu)
