...
students: [ 
    tony-lam, etienne-laccruche, ammar-mehicevic
]
instructors: [
...
techs: [sphero]
videos: [
    {src: "fTHYSRMObBw?si=d397dHuAz5jL4AnX", caption: " Short Sphero workshop "},
    {src: "LAu1CeJtu_Q?si=9sGZ2T0Pe2HvM3mx" , caption: " Installing Sphero Edu "}, 
    {src: "ej4uR7sUrAw?si=fhxp9aIXD1J4kcyd" , caption: " Creating a Teacher Sphero.edu Account "}, 
    {src: "3PSOkOrgY9g?si=E8uA65XJDn2s55Mh" , caption: " Creating a Classroom and Adding Students in Sphero Edu "}, 
    {src: "SYQ1Sk9o07E?si=FjBiG7TCT7iBvtg7", caption: " Creating a Program in Sphero Edu "}
]
tags: []
...
relatedIds: ["ball-is-life"]
images: [
     { src: './JediImage.jpg', alt: 'Jedi at S3 photo'},
    { src: './JediGroupPhoto.jpg', alt: 'Jedi group photo'},
]
imageLogoLight: ./jedi-logo-light.png
...
## Team members
<Photo src={JediGroupPhoto.src} alt="JediPhoto" caption="From left to right: Tony Lam, Ammar Mehicevic and Etienne Laccruche"/>
<br />
